\section{Coloración Guiada por Texto}
...
Seleccionamos el dataset \texttt{Oxford Flowers102}, que incluye para cada imagen de la flor correspondiente, una descripción textual detallada. Estas descripciones suelen mencionar explícitamente los colores de los pétalos, hojas o centros, lo cual resulta ideal para un modelo de coloración guiada.
...
Para la etapa de aprendizaje se empleó \textbf{MSE (Mean Squared Error)} como función de pérdida, comparando píxel a píxel la imagen generada con la imagen real. Para tarea de coloración resulta ser de las más útiles ya que consiste en aproximar colores continuos.  
...
\begin{table}[H]
\centering
\caption{Métricas de evaluación de la colorización guiada por texto}
\label{tab:text_guided_metrics}
\vspace{0.2cm}
\begin{tabular}{lc}
\hline
\textbf{Métrica} & \textbf{Text Guided} \\ \hline
SSIM  & 0.8412 \\ 
PSNR  & 21.7484 \\ 
LPIPS & 0.1776  \\ \hline
\end{tabular}
