...
La combinación de ambas ramas permite obtener coloraciones altamente detalladas y cromáticamente realistas, superando a numerosos métodos previos basados exclusivamente en GANs \cite{Kang_2023_ICCV}.
...
\begin{itemize}
\item Incondicional: Permite la coloración automática al estilo de DDColor.
