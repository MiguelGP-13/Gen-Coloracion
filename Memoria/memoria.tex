...
y el tipo de condicionamiento en la calidad perceptual de los resultados. Los 
hallazgos contribuyen a comprender el potencial y las fronteras actuales de las 
técnicas de coloración basadas en deep learning. \\
...
\addtocontents{toc}{\protect\newpage} %% Para que en el tableofcontents no se quede ahí separando el 8
\input{Capítulos/text-guided}
\input{Capítulos/7-conclusion}

\printbibliography[heading=bibintoc] %% Añade bibliografía a tableofcontents
